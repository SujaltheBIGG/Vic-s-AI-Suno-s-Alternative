...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Vic’s AI`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Vic’s AI.`;
...
const resetMetaTags = () => {
    document.title = 'Vic’s AI - Local AI Music Generator';
    const defaultDescription = 'Create original music with AI locally. Generate songs in any style with custom lyrics and professional quality using Vic’s AI.';
    ...
    updateMeta('meta[property="og:title"]', 'Vic’s AI - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Vic’s AI - Local AI Music Generator');
