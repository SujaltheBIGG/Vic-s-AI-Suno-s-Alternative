  ...
  return (
    <div className="flex-1 bg-white dark:bg-black overflow-y-auto p-6 lg:p-10 pb-32 transition-colors duration-300">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Star Repo */}
        <a
          href="https://github.com/SujaltheBIGG/Vic-s-AI-Suno-s-Alternative"
          target="_blank"
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">SujaltheBIGG/Vic-s-AI-Suno-s-Alternative</p>
